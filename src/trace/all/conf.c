...
static int handle_event(void *ctx, void *data, size_t data_sz)
{
     ...
     */
    if (strcmp("gnome-terminal-", e->comm) == 0 && my_args_conf.if_output_to_file == false) {
        return 0;
    }
    ...
    switch (e->event_type) {
        ...
        case EVENT_FILE_OPEN: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    /**
                ...
                else if (my_args_conf.if_output_as_origin) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-20s %-7d %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->openFileArguments.open_dfd,
                            e->openFileArguments.open_filename,
        ...
        case EVENT_FILE_DELETE: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-20s %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->deleteArguments.delete_dfd,
                            e->deleteArguments.delete_pathname,
        ...
        case EVENT_FILE_RENAMEAT_2: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-20s %-7d %-20s %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->renameat2Arguments.rename_olddfd,
                            e->renameat2Arguments.rename_oldname,
        ...
        case EVENT_FILE_CHANGE_MODE: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-20s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->changeModeArguments.chmod_dfd,
                            e->changeModeArguments.chmod_mode,
        ...
        case EVENT_FILE_GET_MODE: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-7d %-20s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->getModeArguments.stat_mode,
                            e->getModeArguments.stat_uid,
        ...
        case EVENT_FILE_CHANGE_DIR: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-20s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->changeDirArguments.chdir_filename);
                }
        ...
        case EVENT_FILE_MAKE_DIR: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-20s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,e->event.ppid, process_type,
                            e->makeDirArguments.mkdir_mode,
                            e->makeDirArguments.mkdir_filename);
                }
        ...
        case EVENT_FILE_READ_FILE: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7lld %-7d %-7d %-7lld %-20s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->readFileArguments.inode,
                            e->readFileArguments.fileuser,
                            e->readFileArguments.filemode,
        ...
        case EVENT_NETWORK_CONNECT: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-5d %-5d %-39s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->connectArguments.fd,
                            e->connectArguments.addrlen,
                            e->connectArguments.sa_family,
        ...
        case EVENT_NETWORK_SOCKET: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->socketArguments.family,
                            e->socketArguments.type,
                            e->socketArguments.protocol);
        ...
        case EVENT_NETWORK_TCP_IPV4: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7hu %-7hu %-15u %u.%u.%u.%u\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->tcpIpv4ConnectArguments.addr_len,
                            e->tcpIpv4ConnectArguments.sin_family,
                            e->tcpIpv4ConnectArguments.sin_port,
        ...
        case EVENT_NETWORK_SENDTO: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-5d %-5d %-5d %-5d %-5d %-39s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->sendArguments.fd,
                            e->sendArguments.len,
                            e->sendArguments.flags,
        ...
        case EVENT_PROCESS_FORK: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-10s %-7d %-10s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->forkArguments.parent_pid,
                            e->forkArguments.parent_comm,
        ...
        case EVENT_PROCESS_CLONE: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7ld %-7ld %-7ld %-10p %-10p \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->cloneArguments.clone_flags,
                            e->cloneArguments.newsp,
                            e->cloneArguments.tls,
        ...
        case EVENT_PROCESS_EXIT: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-5d %-7d %-20s %-7d \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->exitArguments.exit_code,
                            e->exitArguments.pid,
                            e->exitArguments.comm,
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    */
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->dupFileArguments.dup_fildes);
                }
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    */
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->dup2FileArguments.dup2_oldfd,
                            e->dup2FileArguments.dup2_newfd);
        ...
        case EVENT_FILE_CHMOD:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7s %-7o\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->chmodFileArguments.chmod_pathname,
        ...
        case EVENT_FILE_LINK:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7s %-7s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->linkFileArguments.link_oldpath,
                            e->linkFileArguments.link_newpath);
        ...
        case EVENT_FILE_LINKAT:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7s %-7d %-7s %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->linkatFileArguments.linkat_olddfd,
                            e->linkatFileArguments.linkat_oldname,
        ...
        case EVENT_FILE_FCHMOD:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7o\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->fchmodFileArguments.fchmod_fd,
                            e->fchmodFileArguments.fchmod_mode);
        ...
        case EVENT_FILE_MKDIRAT:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-10s %-7o\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->mkdiratFileArguments.mkdirat_dfd,
                            e->mkdiratFileArguments.mkdirat_name,
        ...
        case EVENT_FILE_RENAME:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-10s %-10s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->renameFileArguments.rename_oldname,
                            e->renameFileArguments.rename_newname);
        ...
        case EVENT_FILE_SYMLINKAT:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-10s %-7d %-10s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->symlinkatFileArguments.symlinkat_oldname,
                            e->symlinkatFileArguments.symlinkat_fd,
        ...
        case EVENT_FILE_UNLINK:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-10s\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->unlinkFileArguments.unlink_name);
                }
        ...
        case EVENT_FILE_TRUNCATE:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-10s %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->truncateFileArguments.truncate_path,
                            e->truncateFileArguments.length);
        ...
        case EVENT_FILE_PREADV:{
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-7d %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->preadvFileArguments.read_fd,
                            e->preadvFileArguments.read_vlen,
         ...
         case EVENT_PROCESS_EXECVEAT: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-10s %-7d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->execveatArguments.fd,
                            e->execveatArguments.filename,
        ...
        case EVENT_PROCESS_EXIT_GROUP: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7ld %-7ld %-7ld %-7ld \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->ptraceArguments.request,
                            e->ptraceArguments.pid,
        ...
        case EVENT_PROCESS_VFORK: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type);
                }
            }
        ...
        case EVENT_PROCESS_MMAP: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7ld %-7ld %-7ld %-7ld %-7ld %-7ld \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                            e->mmapArguments.addr,
                            e->mmapArguments.len,
        ...
        case EVENT_PROCESS_MPROTECT: {
            ...
            if (my_args_conf.if_output_to_file) {
                if (my_args_conf.if_output_as_json) {
                    ...
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7ld %-7zu %-7ld \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid,
                            e->event.ppid, process_type,
                           e->mprotectArguments.start,
                            e->mprotectArguments.len,
        ...
        case EVENT_NETWORK_ACCEPT: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-5d \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->acceptArguments.fd,
                            e->acceptArguments.upper_addrlen,
                            e->acceptArguments.sa_family);
        ...
        case EVENT_NETWORK_ACCEPT4: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-5d %-5d \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->accept4Arguments.fd,
                            e->accept4Arguments.upper_addrlen,
                            e->accept4Arguments.sa_family,
        ...
        case EVENT_NETWORK_RECVMMSG: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-5d %-5d  \n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->recvmmsgArguments.fd,
                            e->recvmmsgArguments.flags,
                            e->recvmmsgArguments.vlen
        ...
        case EVENT_NETWORK_SENDMMSG: {
         ...
         case EVENT_NETWORK_SOCKETPAIR: {
            ...
            if (my_args_conf.if_output_to_file)
            {
                ...
                {
                    fprintf(output_conf, "%-20ld %-10s %-32s %-7d %-7d %-10s %-7d %-7d %-9d %-9d %-9d\n",
                            getCurrentTimestamp(TIMESTAMP_MICROSECOND), event_type, e->event.comm, e->event.pid, e->event.ppid, process_type,
                            e->socketpairArguments.family,
                            e->socketpairArguments.type,
                            e->socketpairArguments.protocol,
...
int test_conf(Args args)
{
    my_args_conf = args;
    if(my_args_conf.if_output_to_file){
        output_conf = fopen(my_args_conf.output_file.c_str(),"w");
        if(output_conf == NULL){
...
const char *default_attach_points[]={{"tp/syscalls/sys_enter_accept"},{"tp/syscalls/sys_exit_accept"},{"tp/syscalls/sys_enter_bind"},
                                    {"tp/syscalls/sys_enter_connect"},{"tp/syscalls/sys_enter_recvfrom"},{"tp/syscalls/sys_enter_sendto"},
                                    {"tp/sched/sched_process_exec"},{"tp/syscalls/sys_enter_kill"},{"tp/syscalls/sys_enter_clone"},
                                    {"tp/sched/sched_process_exit"},{"tp/sched/sched_process_fork"},{"tp/syscalls/sys_enter_newlstat"},
                                    {"kprobe/vfs_open"},{"kprobe/vfs_read"},{"kprobe/vfs_write"},
                                    {"tp/syscalls/sys_enter_chdir"},{"tp/syscalls/sys_enter_chmod"},{"tp/syscalls/sys_enter_link"},
                                    {"tp/syscalls/sys_enter_mkdir"},{"tp/syscalls/sys_enter_rename"},{"tp/syscalls/sys_enter_rmdir"},
                                    {"tp/syscalls/sys_enter_unlink"},{"tp/syscalls/sys_enter_close"}};
...
const char *attach_points[80];
 printf("Error polling perf buffer: %d\n", my_args_conf.if_output_as_custom);
if(my_args_conf.if_output_as_custom==1){
const char* syscalls[] = {
    "tp/syscalls/sys_enter_execve","tp/syscalls/sys_enter_setgid","tp/syscalls/sys_enter_openat","kprobe/do_sys_openat2",
    "tp/syscalls/sys_enter_unlinkat","tp/syscalls/sys_enter_renameat2","tp/syscalls/sys_enter_fchmodat","tp/syscalls/sys_enter_socket",
    "tp/syscalls/sys_enter_sendmsg","tp/syscalls/sys_enter_recvmsg","tp/syscalls/sys_enter_dup","tp/syscalls/sys_enter_dup2","tp/syscalls/sys_enter_ftruncate",
    "tp/syscalls/sys_enter_fchdir","tp/syscalls/sys_enter_linkat","tp/syscalls/sys_enter_fchmod","tp/syscalls/sys_enter_mkdirat",
    "tp/syscalls/sys_enter_renameat","tp/syscalls/sys_enter_symlink","tp/syscalls/sys_enter_symlinkat","tp/syscalls/sys_enter_truncate",
    "tp/syscalls/sys_enter_pread64","tp/syscalls/sys_enter_preadv","tp/syscalls/sys_enter_pwrite64","tp/syscalls/sys_enter_pwritev",
    "tp/syscalls/sys_enter_setuid","tp/syscalls/sys_enter_setregid","tp/syscalls/sys_enter_setresgid","tp/syscalls/sys_enter_setresuid",
    "tp/syscalls/sys_enter_setreuid","tp/syscalls/sys_enter_pipe","tp/syscalls/sys_exit_pipe","tp/syscalls/sys_enter_pipe2",
    "tp/syscalls/sys_exit_pipe2","tp/syscalls/sys_enter_clone3","tp/syscalls/sys_enter_execveat","tp/syscalls/sys_enter_exit_group",
    "tp/syscalls/sys_enter_ptrace","tp/syscalls/sys_enter_tgkill","tp/syscalls/sys_enter_tkill","tp/syscalls/sys_enter_vfork",
    "tp/syscalls/sys_enter_mmap","tp/syscalls/sys_enter_mprotect","tp/syscalls/sys_enter_accept4","tp/syscalls/sys_exit_accept4",
    "tp/syscalls/sys_enter_getpeername","tp/syscalls/sys_enter_recvmmsg","tp/syscalls/sys_enter_sendmmsg",
    "tp/syscalls/sys_enter_socketpair",
    "tp/syscalls/sys_exit_socketpair"
};
int true_count = 0;
int count=0;
int syscount=0;
FILE *conf;
char line[80];
conf =fopen("conf.xml","r");
struct bpf_program *prog;
if(conf == NULL){printf("Failed to open file\n");goto cleanup;}
 while (fgets(line, 80, conf) != NULL) {
        // 去除行末的换行符
        if (line[strlen(line)-1] == '\n') {
            line[strlen(line)-1] = '\0';
        }
        char key[80];char value[80];
        ...
        continue;
         ...
         if (strcmp(value, "true") == 0) {
                     printf("count: %d\n", count);
            // Allocate memory for the key and copy it to the dynamic array
            if(count==30||count==31||count==41||count==45){attach_points[true_count] = syscalls[syscount];printf("%s\n", attach_points[true_count]);
            bpf_object__for_each_program(prog, skel->obj) {
        // Set the attach point for the BPF program
        const char *section_name =bpf_program__section_name(prog);
        //printf("%s\n", section_name);
            if (strcmp(section_name,attach_points[true_count])==0) {
            bpf_program__attach(prog);
            printf("%s\n", attach_points[true_count]);
            }
        } 
            true_count++;
            attach_points[true_count] = syscalls[syscount+1];printf("%s\n", attach_points[true_count]);
            bpf_object__for_each_program(prog, skel->obj) {
        // Set the attach point for the BPF program
        const char *section_name =bpf_program__section_name(prog);
        //printf("%s\n", section_name);
            ...
            attach_points[true_count] = syscalls[syscount];
            printf("%s\n", attach_points[true_count]);
            bpf_object__for_each_program(prog, skel->obj) {
        // Set the attach point for the BPF program
        const char *section_name =bpf_program__section_name(prog);
        //printf("%s\n", section_name);
            ...
            if(count==30||count==31||count==41||count==45) syscount++;
            count++;
            syscount++;
    }
    ...
    bpf_object__for_each_program(prog1, skel->obj) {
        // Set the attach point for the BPF program
        const char *section_name =bpf_program__section_name(prog1);
        //printf("%s\n", section_name);
         for (int j = 0; j < (int)sizeof(default_attach_points)/(int)sizeof(default_attach_points[0]); j++) {
            if (strcmp(section_name,default_attach_points[j])==0) {
     ...
     */
    if (!my_args_conf.if_output_as_json&&!my_args_conf.if_output_as_origin) {
        if (my_args_conf.if_output_to_file) {
            fprintf(output_conf, "%-20s %-10s %-32s %-7s %-7s %10s\n",
...
cleanup:
    ...
    for (int j = 0; j < (int)sizeof(attach_points)/(int)sizeof(attach_points[0]); j++) {
        free((void*)attach_points[j]);
    }
    return err < 0 ? -err : 0;
}
